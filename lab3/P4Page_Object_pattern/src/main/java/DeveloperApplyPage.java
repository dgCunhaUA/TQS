...
public class DeveloperApplyPage {
    ...
    WebElement open_options;

    @FindBy(xpath = "//form[@id=\'new_talent_create_applicant\']/section/div/div/fieldset/div[4]/div[2]/div/div")
    WebElement choose_developer_option;
